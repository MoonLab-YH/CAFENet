...
from utils.FSE_evaluator import Evaluator
...
if __name__ == '__main__':
    ...
    # ------------------
    model = CAFENet(nb_class=1, input_size=320, dropout_aspp=0.2, n_shot=n_shot, dropout_dec=[0.2, 0.2], device='cuda')
